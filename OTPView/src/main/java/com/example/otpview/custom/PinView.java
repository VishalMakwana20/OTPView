package com.example.otpview.custom;
...
public class PinView extends AppCompatEditText {
    ...
    private Boolean isOtpFilled = false;
    ...
    private void drawPinView(Canvas canvas) {
        ...
        for (int i = 0; i < mPinItemCount; i++) {
            ...
            else if (getText().toString().length() > i)
    ...
    public void setIsOtpFilled(Boolean isOtpFilled) {
        this.isOtpFilled = isOtpFilled;
    }
